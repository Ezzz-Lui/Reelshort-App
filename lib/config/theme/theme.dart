...
class MaterialTheme {
  ...
  static const customColor1 = ExtendedColor(
    seed: Color(0xff292cd3),
    value: Color(0xff292cd3),
    light: ColorFamily(
      color: Color(0xff565992),
      onColor: Color(0xffffffff),
      colorContainer: Color(0xffe1e0ff),
      onColorContainer: Color(0xff3e4178),
    ),
    ...
    dark: ColorFamily(
      color: Color(0xffbfc1ff),
      onColor: Color(0xff282b60),
      colorContainer: Color(0xff3e4178),
      onColorContainer: Color(0xffe1e0ff),
    ),
